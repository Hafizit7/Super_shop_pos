...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('paymentApp', '0025_alter_shipingaddress_phone'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoris', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pos_dashboard.productcategory', verbose_name='Product Category')),
                ('price_range', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='store.pricerange')),
            ],
            options={
                'ordering': ['-id'],
            },
